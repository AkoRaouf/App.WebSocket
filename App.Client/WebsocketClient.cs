...
namespace App.Client
{
    ...
    public partial class WebsocketClient : IWebsocketClient
    {
        ...
        {
            Validations.ValidateInput(url, nameof(url));
        ...
        public Uri Url
        {
            ...
            set
            {
                Validations.ValidateInput(value, nameof(Url));
                _url = value;
            }
        }
